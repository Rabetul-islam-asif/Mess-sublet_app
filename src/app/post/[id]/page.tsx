                 ...
                 <div>
                   ...
                   <div className="mt-2 flex flex-wrap items-center gap-x-4 gap-y-2 text-sm text-slate-500">
                        ...
                        <a 
                          ...
                          className="flex items-center text-primary-600 font-bold hover:underline gap-1 transition-all"
                        >
                          <span className="h-1 w-1 rounded-full bg-slate-300 mr-1 hidden md:block" />
                          View on Google Maps
                        </a>
                    </div>
                 </div>
